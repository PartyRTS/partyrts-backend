...
public class UserController {
    ...
    public void deletePlaylistByUser(@PathVariable long userId,@PathVariable  long playlistId) throws UserNotFoundException {
        userService.deletePlaylistByUser(userId,playlistId);
    }
}
